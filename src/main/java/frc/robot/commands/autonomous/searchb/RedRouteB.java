...
public class RedRouteB extends SequentialCommandGroup {
    ...
    public RedRouteB(DriveSub drivetrain) {
        // Add your commands in the addCommands() call, e.g.
        // addCommands(new FooCommand(), new BarCommand());

        addCommands(new TurnDegreesGyro(TurnSpeed, -130, drivetrain).andThen(new WaitCommand(_WAITTIME)),
                ...
                new DriveDistance(StraightSpeed, 246, drivetrain).andThen(new WaitCommand(_WAITTIME))
        );
    }
}
