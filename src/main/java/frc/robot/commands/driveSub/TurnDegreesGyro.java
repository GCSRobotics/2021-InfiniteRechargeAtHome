...
public class TurnDegreesGyro extends CommandBase {
  ...
  private final PIDController m_pidController = new PIDController(0.2, 0, 0.02);
  ...
  public void initialize() {
    ...
    m_Drive.reset();
    m_pidController.setTolerance(2.5, 5); 
  ...
  public boolean isFinished() {
   ...
   // double gyroAngle = m_Drive.getGyroAngle();
    ...
    SmartDashboard.putBoolean("turning is finished", m_pidController.atSetpoint());
